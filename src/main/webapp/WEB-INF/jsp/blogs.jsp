        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <div class="row">
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  </div><a href="${pageContext.request.contextPath}/blog-post/${blog.ceoTitle}/${blog.id}">
            ...
            <c:if test="${currentPage>1}">
                <li class="page-item"><a href="/blogs/${currentPage-1}" class="page-link"> <i class="fa fa-angle-left">
                
                </i></a></li></c:if>
                   <c:forEach var="p" begin="1" end="${totalPage}">
                   <c:choose><c:when test="${p==currentPage }">
                <li class="page-item"><a href="/blogs/${p}" class="page-link active">${p}</a></li></c:when>
                <c:otherwise><li class="page-item"><a href="/blogs/${p}" class="page-link">${p}</a></li></c:otherwise>
                
                </c:choose>
               </c:forEach>
               <c:if test="${currentPage<totalPage}">
                <li class="page-item"><a href="/blogs/${currentPage+1}" class="page-link"> <i class="fa fa-angle-right"></i></a></li> </c:if>
              </ul>
            </nav>
          </div>
        </main>
