    ...
    <div class="container">
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3">Search results for "${text}"</h2>
            <div class="row">
              <!-- post -->
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    ...
                    <div class="category"><a href="blog-category/${blog.category.ceoTitle}/${blog.category.id}">${blog.category.name}</a></div>
                  </div><a href="blog-post/${blog.ceoTitle}/${blog.id}">
                    <h3 class="h4">${blog.title}</h3></a>
                  <p class="text-muted">${blog.description}</p>
                  <div class="post-footer d-flex align-items-center"><a href="blog-author/${blog.user.ceoTitle}/${blog.user.username}" class="author d-flex align-items-center flex-wrap">
