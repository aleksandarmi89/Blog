        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form:form action="user-save" method="post" role="form" modelAttribute="user" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <form:input type="file" class="form-control" placeholder="Enter email" path="file"/>
                      </div>
                      
                       <div class="form-group">
                        <label>Image</label>
                        <form:input type="text" class="form-control"  placeholder="Enter email" path="image"/>
                      </div>
