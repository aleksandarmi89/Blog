            ...
            <div class="card card-primary">
              ...
              <form:form action="slider-save" role="form" modelAttribute="slider">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Title</label>
                        <form:input type="text" class="form-control" placeholder="Enter titlr" path="title"/>
                      </div>
                       <div class="form-group">
                        <label>Url</label>
                       ...
                       <div class="form-group">
                        <label>Button</label>
                        <form:input type="text" class="form-control" placeholder="Enter button name" path="button"/>
                       
                      </div>
                       <div class="form-group">
                        <label>Priority</label>
                        <form:input type="text" class="form-control" placeholder="Enter priority" path="priority"/>
                      </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="${pageContext.request.contextPath}/admin/sliders" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form:form>
              <!-- Form end -->
