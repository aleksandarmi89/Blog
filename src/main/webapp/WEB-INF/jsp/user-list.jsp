                    ...
                    <tr>
                      ...
                      <td>
                       ...
                       <td class="text-center">
                        <img src="${pageContext.request.contextPath}/front/img/${user.image}" style="max-width: 80px;">
                      </td>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          ...
                          <c:choose><c:when test="${user.enable}">
                          ...
                          <c:otherwise>
                           ...
                           <a href="user-enable?username=${user.username}" class="btn btn-danger">
